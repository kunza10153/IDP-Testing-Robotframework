...
Check Dropdown mission
    [Arguments]     ${JSONTEST}
    Wait Until Element Is Visible    ${BUTTONSEATCH}
    Click Element   ${BUTTONSEATCH} 
    ...
    ${test}         Get Text  ${SELECTDROPDOWNFIRST} 
    Should Be Equal     ${test}     ${JSONTEST}